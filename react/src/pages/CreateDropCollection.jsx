...
import contractABI from '../contracts/DropCollection.json'
...
export default function CreateDropCollection() {
    ...
    const groupUpload = async () => {
        ...
        //
        //     const metadataUpload = await pinata.upload.file(
        //       artwork
        //     ).group('c4bdefde-556e-43e0-84e9-6a6a36f27c95');
        //     console.log(`https://gateway.pinata.cloud/ipfs/${metadataUpload.IpfsHash}`)
        //   })
        // );
        // const metadataUpload = await pinata.upload.file(
        //       artwork
        //     ).group('b1553b09-ac86-4dea-86fc-cd3a90144f1a');
        //     console.log(`https://gateway.pinata.cloud/ipfs/${metadataUpload.IpfsHash}`)
        ...
        // const result = await pinata.groups.addCids({
        //         groupId: "c4bdefde-556e-43e0-84e9-6a6a36f27c95",
    ...
    const deploy = async () => {
        ...
        try {
            ...
            const transaction = await contractFactory.deploy(
                ...
                description, // Description
                metadataURL, // Base URI for metadata
                maxSupply, // Max supply
                ethers.parseEther(price), // Mint price in ETH
            ...
            if (transactionReceipt.status === 1) {
                const collectionData = {
                    ...
                    description,
                    userAddress: accounts[0], // User's account address
    ...
    return (
        <div className="mx-auto p-8">
            ...
            <button onClick={groupUpload}>Group Upload</button>
